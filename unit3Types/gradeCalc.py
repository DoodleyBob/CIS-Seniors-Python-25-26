...
print(f"Your exam average: {examAvg:.2f}")
print(f"Student's programming average on programming assignments: {progAvg:.2f}")
print(f"Students assignment average: {assignAvg:.2f}")
print(f"The students overall average: {overallAvg:.2f}")
